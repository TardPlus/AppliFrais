 ...
 */
  ...
  $etape=lireDonnee("etape","validerAjoutLigneHF");
  ...
  $dateHF = $json->Date;
  $libelleHF = $json->Libelle;
  $montantHF = $json->Montant;
  ...
  header('Location: http://192.168.1.91:97/appliFrais/cSaisieFicheFrais.php');
      }
  }
